 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.moplaf2.tousesolver.impl.BucketImpl#getTag <em>Tag</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BucketImpl extends MinimalEObjectImpl.Container implements Bucket {
	...
	protected EClass eStaticClass() {
		return ToUseSolverPackage.Literals.BUCKET;
	}
	...
	public void setTag(String newTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToUseSolverPackage.BUCKET__TAG, oldTag, tag));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToUseSolverPackage.BUCKET__TAG:
				return getTag();
		}
